...
public class Utils {
	...
	// esse metodo serve para casos de converter inteiro n�o ter que tratar
	// exception
	...
	// metodo de forma��o de DATE
	// voc� coloca a tabela a ser formatada, e como vai ser o formato da data
	// EXEMPLO: "dd/MM/yyyy"
	...
	// Metodo de formata��o de numeros com ponto flutuante
	// voc� coloca a tabela a ser formatada, e quantos pontos decimais v�o estar
	// depoisda virgula
